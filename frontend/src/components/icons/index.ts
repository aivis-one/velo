/**
 * VELO Frontend -- Icon Components barrel export (DS-5, S2-S3 speedrun extension)
 *
 * SVG icons rendered as Vue components. All use currentColor and accept a `size` prop (default 24).
 *
 * Usage:
 *   import { IconHome, IconCalendar } from '@/components/icons'
 */

// S1 baseline (13 icons)
...
// S2-S3 speedrun MEGA-1 additions (11 icons)
...
export { default as IconHandsClap } from './IconHandsClap.vue'
export { default as IconHeart } from './IconHeart.vue'
export { default as IconTheme } from './IconTheme.vue'

// S2-S3 speedrun MEGA-2 additions (14 icons)
export { default as IconMic } from './IconMic.vue'
export { default as IconCheck } from './IconCheck.vue'
export { default as IconBookDream } from './IconBookDream.vue'
export { default as IconBookFeather } from './IconBookFeather.vue'
