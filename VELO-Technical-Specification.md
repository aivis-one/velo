...
(cross-practice отзывы мастера). Все LIVE на `test`.

**Ревью — закрыто кодом:** W-1 (явка по PRE-чек-ину в обоих путях финализации),
...
**Открыто (бэкенд):** TD-ASK-MASTER → теперь часть E4 (messaging, P1); E7 period-stats
(P1); E3 recurrence (P1); E8 notifications contract+delivery (P1/P2); E11 one-offs;
P2-хвост. TD-NOTIF-RACE (3 класса нотификаций под skip) — без изменений.
...
**Тесты:** 480 -> 564 passed, 12 skipped.
