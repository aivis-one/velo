...
Last updated: 2026-05-18 (Calendar 11 DS harvest complete — Macro-Phase I 3/10)
Sprint reference: **Sprint 2 EXPANDED + in-progress (file `05_roadmap/sprint-02.md`) — Macro-Phase I: DS harvest all 10 blocks (Onboarding ✅ + Dashboard 9 ✅ + Calendar 11 ✅ done, Profile 7 next). Macro-Phase II: all block mockups after DS Complete Gate. Parallel: Sprint 2.5 (standalone `05_roadmap/sprint-02.5.md`) — Track B CBSHOME + Track C docs translation.**
...
| `03_mockups/` | Operator's visual workspace (not shipped) | `INDEX.md` | populating — Onboarding 8 ✅ + Dashboard 9 ✅ ready for MOCKUP GATE · Macro-Phase II pending DS Complete Gate |
