...
Steps:
1. **Ground:** open Figma reference, read its spec. Capture target screen name, route, role (user/master/admin), target file path (`frontend/src/views/<role>/<File>.vue`), and relevant tokens from `docs/05_legacy/Design_prototype_legacy_2026-03-11/tokens.md`.
