# Resolution
> SPEC v3.2-velo | Transform ambiguity into implementable architectural decisions
...
|-----------|---------|-----------------|
| Strategic ambiguity | "Something feels off about the design-gen approach" | 02_Sprint-Builder |
| Contradictions in docs | "ARCHITECTURE says X, Figma shows Y" | mid-sprint escalation |
| Raw ideas need structure | "I think we need a feedback loop on Claude Design lessons" | 02_Sprint-Builder scope decisions |
| Architecture conflicts | "Redesign direction clashes with existing tokens" | mid-sprint escalation |
