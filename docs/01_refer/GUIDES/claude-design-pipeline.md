...
- [ ] Existing tokens in `docs/05_legacy/Design_prototype_legacy_2026-03-11/tokens.md` reviewed
...
per docs/05_legacy/Design_prototype_legacy_2026-03-11/tokens.md, glassmorphism with backdrop-blur(2px),
...
2. Figma file link
3. `docs/05_legacy/Design_prototype_legacy_2026-03-11/tokens.md` as a separate file (if tool doesn't parse md subfolders)
